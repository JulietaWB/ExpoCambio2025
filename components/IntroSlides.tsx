    ...
    icon: (
      <div className="flex space-x-8">
        <div className="flex flex-col items-center space-y-2">
            ...
            <span className="font-medium text-slate-300">Economía</span>
        </div>
        <div className="flex flex-col items-center space-y-2">
            <LeafIcon className="w-16 h-16 text-green-400" />
            <span className="font-medium text-slate-300">Ecosistema</span>
        </div>
        <div className="flex flex-col items-center space-y-2">
            <HappinessIcon className="w-16 h-16 text-pink-400" />
            <span className="font-medium text-slate-300">Felicidad</span>
        </div>
      </div>
    ),
  ...
  },
  {
    icon: (
      <div className="flex justify-center items-center -space-x-4">
          <BusinessmanAvatar className="w-20 h-20 rounded-full border-4 border-slate-800 shadow-lg" />
          <ActivistAvatar className="w-20 h-20 rounded-full border-4 border-slate-800 shadow-lg" />
          <FamilyManAvatar className="w-20 h-20 rounded-full border-4 border-slate-800 shadow-lg" />
          <SmallBusinessOwnerAvatar className="w-20 h-20 rounded-full border-4 border-slate-800 shadow-lg" />
      </div>
    ),
...
const IntroSlides: React.FC<IntroSlidesProps> = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/90 backdrop-blur-md flex flex-col items-center justify-center z-50 p-4 text-center">
        <div className="w-full max-w-lg bg-slate-800 p-8 md:p-12 rounded-xl shadow-2xl intro-slide">
            ...
            <p className="text-slate-300 text-lg mb-8 min-h-[100px]">{slide.description}</p>
