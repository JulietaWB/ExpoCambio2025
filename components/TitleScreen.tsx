...
const TitleScreen: React.FC<TitleScreenProps> = ({ onStart }) => {
  return (
    <div className="interland-bg fixed inset-0 flex flex-col items-center justify-center p-4 text-center z-50 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold text-green-700 mb-4 tracking-tighter drop-shadow-lg">
          El Dilema del Alcalde
        </h1>
        <p className="text-lg md:text-xl text-green-900 mb-8 max-w-2xl mx-auto drop-shadow-sm">
